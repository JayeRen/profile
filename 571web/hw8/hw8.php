            ...
            <div class="big rounded">
                <div class="card" id="favorite-chart" style="display:block">
                    ...
                    <div class="card body">
                        ...
                        <table id="favorite-table" class="table table-striped">
                            <tr>
                                <th>Symbol</th>
                                <th>Stock Price</th>
...
News Feeds</a>
                    ...
                    -------------------------------------------------------->
                            <div class="tab-pane fade show active" id="stock_info" role="tabpanel" aria-labelledby="cs">
                                ...
                                <table id='current_stock' class="table table-striped">
                                    <tr>
                                        <!--   --------------------------------------------  
                                        ...
                                        <td id="graph_col" style="vertical-align:top">
                                            <div class="container">
                                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" id="Price" data-toggle="tab" href="#" role="tab" aria-controls="home" aria-selected="true">Price</a>
                                                    </li>
                                                    <li class="nav-item">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#search").click(function(event) {
            ...
            $.ajax({
                //type: "GET",
                url: "http://cs-server.usc.edu:35019/search.php",
                async: true,
                ...
                success: function(data) {
                    ...
                    //highstock
                   var ind=data.sts; $l='https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol='+ind.toLowerCase()+'&apikey=ZH0JISPRJNEON69U';
